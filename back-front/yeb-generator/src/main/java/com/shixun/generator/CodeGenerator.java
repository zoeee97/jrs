...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setSwagger2(true); //实体属性 Swagger2 注解 生成接口文档
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://localhost:3306/yeb-sys?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("20011213");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.shixun.server")
                .setEntity("pojo")
                .setMapper("mapper")
                .setService("service")
        ...
        */
        ...
        //数据库表映射到实体的命名策略 下划线转成驼峰命名
        strategy.setNaming(NamingStrategy.underline_to_camel);
        //数据库表字段映射到实体的命名策略 本身就是驼峰 无需改变
